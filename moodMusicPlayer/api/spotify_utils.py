    ...
    if access_token:
        try:
            ...
            set_key(dotenv_path, 'ACCESS_TOKEN', access_token)
                # store access token token as enivronment variable
            # print(access_token)
...
def get_token(client_id, client_secret):
    ...
    try:
        ...
        if access_token:
            ...
            # return {'access_token': access_token}  # Return a dictionary
            return access_token
        else:
...
# validate_client_credentials(clienrt_id, client_secret)
...
# Function to delete the .env file
# def delete_env_file():
#     if os.path.exists(dotenv_path):
#         os.remove(dotenv_path)
#         print(f"{dotenv_path} has been deleted.")
#     else:
#         print(f"{dotenv_path} does not exist.")
# delete_env_file()